		...
		<div class="flex flex-col grow h-full md:flex-row gap-x-10 gap-y-8 px-10 items-center h-full pt-4 md:pt-0 pb-10 md:pb-0">
			<div class="mt-10 md:w-1/2 sm:mt-0">
				...
				<p class="dark:text-gray-300 my-7">
					Explore the easiest way to quickly, yet efficiently manage lots of
					different types of databases, all under one easy to use and powerful
					api. Paired with providers ranging from MongoDB and SQL to JSON, and
					Middleware such as caching and schema validation, Josh is the easiest
